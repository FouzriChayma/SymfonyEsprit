 ...
 */
class getClassroomRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClassroomRepository' shared autowired service.
     *
     * @return \App\Repository\ClassroomRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClassroomRepository.php';

        return $container->privates['App\\Repository\\ClassroomRepository'] = new \App\Repository\ClassroomRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
